...
function query_dbs(res, fullName) {
	...
	query = "select P.Name, SP.OREB from SeasonPerformance SP natural join Player P natural join PlaysFor natural join Season S where S.Start_Year = " + fullName + " order by SP.OREB desc limit 10";
